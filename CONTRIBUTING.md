# Contributing to Flight Starter

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Starter? Welcome! Please read this
...
You can help Flight Starter by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-starter/issues?state=open)
...
If you find a bug - behaviour of Flight Starter code or documentation
...
[GitHub issue tracker for Flight Starter](https://github.com/openflighthpc/flight-starter/issues/new)
to report the issue.
...
We want to improve the quality of Flight Starter and good bug reports are
...
Flight Starter is Open Source and comes without warranty.
...
Flight Starter in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Starter and really improve it. The more
...
applied to Flight Starter itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-starter). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Starter developers also have their regular
